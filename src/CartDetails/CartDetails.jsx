...
import { useNavigate, Route, Link, useParams } from 'react-router-dom';
      ...
      <>
        <form className="checkout__form" onChange={this.handleFormChanges}>
          ...
          <div>
            ...
            <Row>
              <Button className="checkout__label" htmlFor="shippingCountry" type="submit" onClick={this.submitButton}>Submit</Button>
            </Row>
          </div>
